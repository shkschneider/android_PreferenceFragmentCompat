...
import android.support.v4.preference.R;
...
public abstract class PreferenceFragmentCompat extends Fragment implements PreferenceFragmentCompatManager.OnPreferenceTreeClickListener {
    ...
    /**
     * Interface that PreferenceFragmentCompat's containing activity should
    ...
    public void addPreferencesFromResource(int preferencesResId) {
        ...
        setPreferenceScreen(PreferenceFragmentCompatManager.inflateFromResource(mPreferenceManager, getActivity(),
